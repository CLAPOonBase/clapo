...
export default function UserProfilePage({ params }: { params: { userId: string } }) {
  ...
  }, [params.userId, currentUserId, isOwnProfile])
  ...
  const checkFollowStatus = async () => {
    ...
    try {
      ...
      const followersResponse = await getUserFollowers(params.userId, 100, 0)
  ...
  const handleFollowToggle = async () => {
    ...
    try {
      if (isFollowing) {
        await unfollowUser(params.userId, { followerId: currentUserId })
        ...
        await followUser(params.userId, { followerId: currentUserId })
        setIsFollowing(true)
        if (userProfile) {
          setUserProfile({
            ...userProfile,
