...
export default function InvitePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      {/* Header */}
      <div className="flex items-center justify-between p-4 border-b-2 border-gray-700/70 sticky top-0 bg-black z-10">
        <button
          onClick={() => router.back()}
        ...
        <h1 className="text-xl font-semibold text-white">Invite Friends</h1>
        <button
          onClick={() => router.back()}
