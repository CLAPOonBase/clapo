  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      <button
        ...
        className="relative p-2 text-gray-400 hover:text-white transition-colors rounded-lg hover:bg-[#2A2A2A]"
      >
        <Bell className="w-6 h-6" />
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-[#6E54FF] text-white text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-[0px_1px_0.5px_0px_rgba(255,255,255,0.33)_inset,0px_1px_2px_0px_rgba(26,19,161,0.50),0px_0px_0px_1px_#4F47EB]">
            ...
            <div className="flex items-center space-x-2">
              {unreadCount > 0 && (
                <button
                  ...
                  disabled={loading}
                  className="px-3 py-1 text-xs bg-[#6E54FF] hover:bg-[#836EF9] text-white rounded-md transition-colors disabled:opacity-50 shadow-[0px_1px_0.5px_0px_rgba(255,255,255,0.33)_inset,0px_1px_2px_0px_rgba(26,19,161,0.50),0px_0px_0px_1px_#4F47EB]"
                >
                ...
                {notifications.slice(0, 10).map((notification) => (
                  <div
                    ...
                    className={`p-4 hover:bg-[#2A2A2A] transition-colors cursor-pointer ${
                      !notification.is_read ? 'bg-[#2A2A2A]/30' : ''
                    }`}
          ...
          {notifications.length > 0 && (
            <div className="p-3 border-t border-[#2A2A2A] text-center">
              <button
                ...
                className="text-[#6E54FF] hover:text-[#836EF9] text-sm font-medium transition-colors"
              >
